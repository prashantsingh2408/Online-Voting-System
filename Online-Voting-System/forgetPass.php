    	...
    	<div class="row">
    		...
    		<div class="col-sm-4" style="border:2px solid gray;padding:50px;">
    			...
    			<div class="page-header">
    				<h2 class="specialHead">Reset Password</h2>
    			</div>
          <form action="forgetPassGetOTP.php" method="POST">
      			<div class="form-group">
      				<label for="">Voter's Registered Email ID</label><br>
      				<input type="text" name="emailID" placeholder="Enter Voter's Registered Email ID" class="form-control"><br>

      		
              
      				<button type="submit" class="btn btn-block span btn-primary "><span class="glyphicon glyphicon-user"></span> Get OTP</button>
