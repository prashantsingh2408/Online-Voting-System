    	...
    	<div class="row">
          ...
          <form action="updatePwd.php" method="POST">
      			<div class="form-group">
      				...
      				<input type="password" name="OTPNewPass" class="form-control" placeholder="Enter New Password"><br>

              <label for="">Retype Password</label><br>
              <input type="password" name="OTPRetryNewPass" class="form-control" placeholder="Enter New Password Again"><br>
