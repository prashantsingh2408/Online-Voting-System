    ...
    <div class="container" style="padding-top:150px;">
    	<div class="row">
          ...
          require('config.php');
					...
					if(isset($_POST["upVName"]) && isset($_POST["upVEmail"]) && isset($_POST["providedVID"]))
					{
						$upVName= test_input($_POST["upVName"]);
						$upVEmail= test_input($_POST["upVEmail"]);
						$providedVID= test_input($_POST["providedVID"]);
       ...
       $DB_NAME="db_evoting";
        ...
        or die("Couldn't Connect to Database :");
				...
				$sql = "UPDATE db_evoting.tbl_users SET full_name='".$upVName."' , email='".$upVEmail."' WHERE voter_id='".$providedVID."'";	
